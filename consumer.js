console.log("Loaded BJN SDK = ", BJN);
var RTCManager = BJN.RTCManager
var defaultRTCParams = BJN.defaultRTCParams
var RTCClient = BJN.RTCClient

var initializeBJN = function () {
